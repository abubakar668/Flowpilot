...
from apps.fp_base_view import BaseView
...
def index(request):
    ...
    :return:
    """
    return HttpResponse("This is flowpilot's api server, please view frontend page, reference: http://flowpilot.readthedocs.io/")
