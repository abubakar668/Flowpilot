...
class TestAccountModel(TestCase):
    ...
    def test_fp_user_get_dict(self):
        """
        测试获取字典格式用户信息
        :return:
        """
    ...
    def test_fp_user_is_staff(self):
        """
        测试用户staff判断
        :return:
        """
    ...
    def test_fp_user_get_short_name(self):
        """
        测试获取short_name
        :return:
        """
    ...
    def test_fp_user_get_alias_name(self):
        """
        测试获取用户昵称
        :return:
        """
    ...
    def test_fp_user_dept_name(self):
        """
        测试获取用户部门名称
        :return:
        """
    ...
    def test_fp_user_get_json(self):
        """
        测试获取用户json格式信息
        :return:
        """
