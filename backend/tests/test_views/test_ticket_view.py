...
from tests.base import FlowpilotApiCall
...
class TestTicketView(TestCase):
    ...
    def test_get_ticket_list_without_arg(self):
        ...
        response_content_dict = FlowpilotApiCall().api_call('get', url)
        self.assertEqual(response_content_dict.get('code'), -1)
    ...
    def test_get_ticket_list_with_arg(self):
        ...
        """
        url = '/api/v1.0/tickets'
        response_content_dict = FlowpilotApiCall().api_call('get', url, {'category':'all', 'username':'wangfei'})
    ...
    def test_new_ticket(self, gen_ticket_sn, notice_apply_async, hook_apply_async):
        ...
        url = '/api/v1.0/tickets'
        result = FlowpilotApiCall().api_call('post', url, params)
        self.assertEqual(result.get('code'), 0)
    ...
    def test_get_ticket_detail(self):
        ...
        result = FlowpilotApiCall().api_call('get', url, dict(username='admin'))
        self.assertEqual(result.get('code'), 0)
    ...
    def test_get_ticket_transition(self):
        ...
        result = FlowpilotApiCall().api_call('get', url, dict(username=username))
        self.assertEqual(result.get('code'), 0)
    ...
    def test_get_ticket_flow_logs(self):
        ...
        result = FlowpilotApiCall().api_call('get', url, dict(username='lilie'))
        self.assertEqual(result.get('code'), 0)
    ...
    def test_alter_ticket_state(self, notice_apply_async):
        ...
        notice_apply_async.return_value = True
        result = FlowpilotApiCall().api_call('put', url, dict(state_id=new_state_id))
        self.assertEqual(result.get('code'), 0)
    ...
    def test_alter_ticket_field_value(self):
        ...
        result = FlowpilotApiCall().api_call('patch', url, dict(username='lilie', title='_test'.format(ticket_title)))
        self.assertEqual(result.get('code'), 0)
    ...
    def test_add_ticket_comment(self):
        ...
        result = FlowpilotApiCall().api_call('post', url, dict(suggestion='test for commnet'))
        self.assertEqual(result.get('code'), 0)
    ...
    def get_ticket_list_by_params(self, params):
        ...
        """
        url = '/api/v1.0/tickets'
        response_content_dict = FlowpilotApiCall().api_call('get', url, params)
