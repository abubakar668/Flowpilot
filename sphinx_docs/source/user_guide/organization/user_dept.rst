...
Flowpilot provides built-in user and department management. You can add, edit, and delete users or departments in the UI, and you can also synchronize them in bulk through the API.
