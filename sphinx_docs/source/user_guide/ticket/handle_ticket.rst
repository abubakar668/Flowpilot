...
After signing in to Flowpilot, open your pending tickets from the left sidebar via **Workbench** or through **Ticket Management → My Duty**. Click **Detail** in the **Action** column to view a ticket. The detail page contains three main areas:
