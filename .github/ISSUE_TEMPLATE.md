---
name: Issue Report
about: Report FlowPilot issues, feature requests, or questions
title: ''
...
## FlowPilot Version
<!-- Please specify the FlowPilot version you are using, e.g., v3.0.1 -->
...
## System Logs Check
<!-- For bug reports, check the system logs (default location: ~/flowpilot.log) and paste relevant logs -->
- [ ] Checked system logs
